        ...
        <div className="mt-10 rounded-3xl border border-ink/5 bg-white p-6 shadow-xl shadow-brand/5 sm:p-9">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="grid gap-5" noValidate>
              ...
              <button
                type="submit"
                className="mt-1 inline-flex w-full items-center justify-center gap-2 rounded-full bg-brand px-7 py-4 text-base font-semibold text-white shadow-lg shadow-brand/30 transition-all hover:-translate-y-0.5 hover:bg-brand-700 hover:shadow-xl"
              >
                {signup.submit}
